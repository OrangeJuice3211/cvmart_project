...
if __name__ == "__main__":
    data_train_root = '../../data/resized_data/'
    data_train_list = './ISIC/Training_seg.txt'
    ...
    data_val_root = '../../data/resized_data/'
    data_val_list = './ISIC/Validation_seg.txt'
    ...
    for i_iter, batch in enumerate(valloader):
        ...
        print(i_iter, name, images.shape, labels.shape)
        # break
